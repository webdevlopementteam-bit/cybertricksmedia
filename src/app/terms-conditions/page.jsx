...
import {
  ArrowRight, ChevronRight, ScrollText, Truck, UserCheck,
  Building2, CreditCard, ShieldAlert, Scale, Headphones,
} from "lucide-react";
...
const SECTIONS = [
  {
    ...
    points: [
      "Campaigns begin only after receipt of payment and required creative materials.",
    ],
  },
  {
    n: "02",
    ...
    points: [
      "Provide correct information, creatives, and approvals on time.",
      "Ensure no ad creative violates copyright, trademark, or legal norms.",
    ],
  },
  {
    n: "03",
    ...
    points: [
      "Cybertricks Media Pvt. Ltd. may refuse or discontinue any advertisement that violates legal, moral, or platform guidelines.",
      "We may update, modify, or revise these terms without prior notice.",
    ],
  },
  {
    n: "04",
    ...
    points: [
      "Full advance payment is required unless mutually agreed otherwise.",
      "Delays in payments may pause ongoing services.",
    ],
  },
  {
    n: "05",
    ...
    points: [
      "We are not responsible for third-party platform issues, technical failures, or unexpected downtime.",
      "Results from digital advertising depend on multiple factors; we do not guarantee fixed outcomes unless committed in writing.",
    ],
  },
  {
    n: "06",
    ...
    points: ["Any disputes are subject to the courts of Delhi, India."],
  },
];
    ...
    <>
      ...
      >
        ...
        <div className="container-x relative z-10">
          ...
          >
            Welcome to Cybertricks Media Pvt. Ltd. By accessing our website or using
            our digital advertising, branding, and marketing services, you agree to
            the following terms.
          </motion.p>
        </div>
                  ...
                  {SECTIONS.map((s) => (
                    <li key={s.id}>
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1 text-[13.5px] font-semibold text-ink transition-colors group-hover:text-brand-600">
                          {s.title}
                        </span>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 max-w-md text-[14.5px] text-white/70">
                        Reach out and we&apos;ll walk you through anything that needs
                        clarifying before you sign.
                      </p>
                    </div>
                  </div>
